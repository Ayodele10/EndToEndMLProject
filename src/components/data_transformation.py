...
class DataTransformation: 
    ...
    def initiate_data_transformation(self, train_path, test_path):   
        ...
        try:
            ...
            input_feature_train_df = train_df.drop(columns=[target_column_name], axis=1) # dropping target column for train data
            target_feature_train_df = train_df[target_column_name] # target column for train data

            input_feature_test_df = test_df.drop(columns=[target_column_name], axis=1) # dropping target column for test data
